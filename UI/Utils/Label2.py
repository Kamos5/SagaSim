...
class Label2:
    ...
    def __init__(self, text, font, clickable=False, focused=False, horizontalMargin = 2, verticalMargin = 2, borderSize=1, onlyText = False, fontColor = (220, 220, 220), multiColor=False, multiColorText=[]):
